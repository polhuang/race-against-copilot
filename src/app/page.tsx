        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="https://youtu.be/0vuPRe4t4sE" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-red-500/10 border-2 border-red-500/70 text-red-400 hover:bg-red-500/20 hover:border-red-400 rounded-lg px-8 py-3 font-medium transition-colors text-lg">
